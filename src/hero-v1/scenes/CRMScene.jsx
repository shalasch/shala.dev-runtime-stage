    ...
    >
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: 22, fontWeight: 700, color: '#0A0A0A', letterSpacing: '-0.03em', lineHeight: 1 }}>94</div>
...
function Field({ label, children }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', minHeight: 17 }}>
      ...
      <span style={{ fontSize: 11, fontWeight: 500, color: 'rgba(0,0,0,0.65)', textAlign: 'right', maxWidth: 115 }}>
        {children}
      </span>
    </div>
  )
...
function ActivityRow({ text, time, color, isLast }) {
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: 11, color: 'rgba(0,0,0,0.68)', lineHeight: 1.4 }}>{text}</div>

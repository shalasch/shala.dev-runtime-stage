...
export default function CalendarScene({ showPayoff }) {
  ...
  return (
    ...
    >
      {/* Calendar body — fades when payoff appears */}
      <motion.div
      ...
      >
        ...
        {/* Grid */}
        <div style={{ padding: '10px 18px 0', flex: 1, display: 'flex', flexDirection: 'column', gap: 0 }}>
            ...
            {showEvt && (
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: 10.5, color: 'rgba(0,0,0,0.40)', marginTop: 2 }}>
                    Thu, Jun 18 · 2:00 PM – 3:00 PM · Barra da Tijuca
                  </div>
                </div>
                <motion.div
                  ...
                  style={{
                    ...
                    border: '1px solid rgba(34,197,94,0.22)',
                    fontSize: 10, fontWeight: 600, color: '#16A34A', flexShrink: 0,
                  }}
                >
                  <CheckIcon /> Booked
                </motion.div>
        ...
        {showPayoff && (
          ...
          >
            ...
            <motion.div
              ...
              style={{ display: 'flex', gap: 6, flexWrap: 'wrap', justifyContent: 'center', maxWidth: 440, marginTop: 4 }}
            >
              {CONFIRM_CARDS.map(c => (
                <motion.div
                  key={c.text}
...
function DayCell({ day, isBooked, clicked, isToday }) {
  if (!day) return <div style={{ height: 28 }} />

...
export default function StageV1() {
  ...
  useEffect(() => {
    ...
    t.push(setTimeout(() => setCur({ x: 440, y: 310 }),   770))
    t.push(setTimeout(() => setCurVis(false),              2150))

    t.push(setTimeout(() => { setCurVis(true); setCur({ x: 840, y: 215 }) }, dbStart + 450))
    t.push(setTimeout(() => setCur({ x: 340, y: 215 }),   dbStart + 950))
    t.push(setTimeout(() => setCur({ x: 510, y: 215 }),   dbStart + 1950))
    t.push(setTimeout(() => setCur({ x: 635, y: 215 }),   dbStart + 2900))
    t.push(setTimeout(() => setCurVis(false),              dbStart + 5100))

    t.push(setTimeout(() => { setCurVis(true); setCur({ x: 840, y: 195 }) }, crmStart + 400))
    t.push(setTimeout(() => setCur({ x: 220, y: 195 }),   crmStart + 920))
    t.push(setTimeout(() => setCur({ x: 220, y: 295 }),   crmStart + 1880))
    t.push(setTimeout(() => setCur({ x: 545, y: 345 }),   crmStart + 2900))
    t.push(setTimeout(() => setCurVis(false),              crmStart + 5600))

    t.push(setTimeout(() => { setCurVis(true); setCur({ x: 430, y: 150 }) }, calStart + 300))
    t.push(setTimeout(() => setCur({ x: 450, y: 218 }),   calStart + 840))
